...
if(c==1)
{out+='<div id="tipue_search_results_count"> 검색 결과 : '+tipuesearch_string_4;}
else
{c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<div id="tipue_search_results_count">검색 결과 : '+c_c+' '+tipuesearch_string_5;}
if(set.showTime)
